...
<!DOCTYPE html>
<!-- Created By Coding Zakir - www.codingzakir.com -->
<html lang="en" dir="ltr">
  <head>     
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Personal Portfolio Website -KL00coding</title>
  ...
  <body>
    ...
    <section class="main" id="main">
      <div class="content">
        <h2>Hello, I'm<br><span>Kyle Laurente</span></h2>
        ...
        <div class="media-icons">
          <a href="https://www.facebook.com/KyleMiguelLaurente" target="_blank"><i class="fab fa-facebook-f"></i></a>
          <a href="https://www.instagram.com/kyle_laurente/" target="_blank"><i class="fab fa-instagram"></i></a>
          <a href="https://twitter.com/km_lrnt" target="_blank"><i class="fab fa-twitter"></i></a>
        </div>
      </div>
    </section>
    ...
    <section class="about" id="about">
      ...
      <div class="content">
        ...
        <div class="column col-right reveal">
          <h2 class="content-title">Hey There! I'm Kyle Laurente</h2>
      ...
      <div class="content">
        <div class="row">
          ...
          <div class="card reveal">
            ...
            <div class="info">
              <h3>Email Address</h3>
              <span>migzlaurente10@email.com</span>
            </div>
          </div>
          <div class="card reveal">
            <div class="contact-icon">
    ...
    <footer class="footer">
      <span class="footer-title">Kyle Laurente</span>
      <p>Copyright @2021 <a href="#">KL00coding</a>. All Rights Reserved.</p>
    </footer>
